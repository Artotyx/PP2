...
def change_image(image, t):
    ...
    return im_rotate
main = pygame.image.load(r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab7\images\main.jpg')
mmm = pygame.image.load(r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab7\images\mmm.png')
sss = pygame.image.load(r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab7\images\sss.png')
