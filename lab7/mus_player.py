...
music_bg = r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab7\musics\images\ФОН.jpg'
controls_images = r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab7\musics\images\пауза.png'
...
def draw_song_photo(music):
    images = r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab7\musics\images\\' + true_name(str(music)) + '.jpg'
    im = pygame.image.load(images)
    screen.blit(im, (170, 50))
    pygame.display.update()
    
path = r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab7\musics'
musics = [ name for name in os.listdir(path) if not os.path.isdir(os.path.join(path, name)) ]

def sing_a_song(musics, i):
    pygame.mixer.music.load(r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab7\musics\\'+str(musics[i]))
