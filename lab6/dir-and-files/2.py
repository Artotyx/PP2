...
import os
print('Существование:', os.access(r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab6\dir-and-files\check1_for1', os.F_OK)) # False так как у меня нет файла check1_for2
print('Чтение доступно:', os.access(r'C:\Users\User\WorkSPACE\Рабочий стол\pp2\PP2\lab6\dir-and-files\check1_for1', os.R_OK))
